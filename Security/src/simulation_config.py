class SimulationConstants:
    ...
    BASELINE_FACILITY_MISSION_TIME = 25  # Reference time for unimpeded operations
    ...
    def get_escort_delay(cls, concurrent_assignments: int) -> int:
        """
        Returns appropriate escort dispatch delay based on resource utilization.
        
        Args:
            concurrent_assignments: Number of active escort assignments
            
        Returns:
            Minutes of delay for this request
        """
    ...
    def calculate_efficiency_rating(cls, actual_mission_time: int) -> int:
        """
        Calculate operational efficiency rating (0-100).
        
        Args:
            actual_mission_time: Total time taken for mission (minutes)
