...
|---|---|
| &bull; Use the **supported simulated reactor track** to improve control, fault detection, safety logic, state estimation, or visualization.<br><br>&bull; Build or extend a temperature, dye-concentration, syringe-pump, or water-flow system as part of the **supported physical analogue track** to demonstrate feedback and safety concepts.<br><br>&bull; Create a **digital reactor control-room simulator** that displays reactor power, coolant conditions, control-rod movement, alarms, and safety state.<br><br>&bull; Develop an **autonomous control-rod optimization tool** that recommends rod movements while respecting operating limits.<br><br>&bull; Build a **wireless auxiliary-system sensor network** that monitors pumps, valves, temperature, flow, or environmental conditions.<br><br>&bull; Design a **redundant sensor validation architecture** that uses voting, sensor fusion, or consistency checks to identify incorrect measurements.<br><br>&bull; Build a **portable instrumentation training rig** that demonstrates measurement, feedback control, disturbances, alarms, and shutdown behaviour. | &bull; Use the **supported simulated reactor track** to investigate reactor kinetics, heat transfer, measurement uncertainty, and the relationship between power, temperature, and reactivity.<br><br>&bull; Use the **supported physical analogue track** to experimentally study temperature, flow, mixing, sensor accuracy, disturbances, and response time in a safe physical system.<br><br>&bull; Develop a **smart sensor health monitoring system** by studying sensor noise, drift, uncertainty, and failure patterns to identify misleading measurements.<br><br>&bull; Create a **digital twin of an SMR cooling loop** that models coolant flow and heat transfer under different operating conditions and disturbances.<br><br>&bull; Design a **predictive instrumentation maintenance platform** that combines knowledge of failure mechanisms with reliability or simulated operating data to predict maintenance needs.<br><br>&bull; Develop an **AI-assisted alarm prioritization system** by analyzing event relationships and creating a method for grouping and ranking alarms during abnormal conditions.<br><br>&bull; Conduct a **human-factors control-panel redesign** that applies cognitive science and human-perception principles to reduce operator mistakes. |
